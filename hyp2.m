...
X=[ones(crossVal,1) U U1 U1.^2 U1.^3 U1.^4];
...
Xnew=[ones(crossValnew,1) Unew U1new U1new.^2 U1new.^3 U1new.^4];
ThetaNew=Theta;
...
Xnew2=[ones(crossValnew2,1) Unew2 U1new2 U1new2.^2 U1new2.^3 U1new2.^4];
ThetaNew2=Theta;
