...
X=[ones(crossVal,1) U U1 U.^2 U1.^3 U.^4 U1.^5];
...
Xnew=[ones(crossValnew,1) Unew U1new Unew.^2 U1new.^3 Unew.^4 U1new.^5];
ThetaNew=Theta;
...
Xnew2=[ones(crossValnew2,1) Unew2 U1new2 Unew2.^2 U1new2.^3 Unew2.^4 U1new2.^5];
ThetaNew2=Theta;
